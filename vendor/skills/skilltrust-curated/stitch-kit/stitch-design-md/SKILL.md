...
description: "Use when the user explicitly mentions Google Stitch and wants a Stitch-derived DESIGN.md or design-language reference synthesized from Stitch project screens."
allowed-tools:
  - "stitch*:*"
  - "Read"
  - "Write"
