...
description: "Use when the user explicitly mentions Google Stitch and wants design tokens, CSS custom properties, Tailwind theme guidance, or code-level design-system artifacts."
allowed-tools:
  - "stitch*:*"
  - "Bash"
  - "Read"
