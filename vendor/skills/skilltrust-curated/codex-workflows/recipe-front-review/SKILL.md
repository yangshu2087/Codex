...
description: "Use when explicitly running a frontend review recipe against React or TypeScript UI work and the operator wants the vendored SkillTrust reference flow."
---
