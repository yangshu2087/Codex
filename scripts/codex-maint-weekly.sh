...
echo "[1/6] Stable channel and installed version"
echo "------------------------------------------"
"$SCRIPTS_DIR/check-codex-upgrade.sh" || true

echo ""
echo "[2/6] Release highlights snapshot (stable + alpha)"
echo "---------------------------------------------------"
python3 - <<'PY'
...
echo ""
echo "[6/6] Suggested actions (no deletion performed)"
echo "-----------------------------------------------"
python3 - <<'PY'
